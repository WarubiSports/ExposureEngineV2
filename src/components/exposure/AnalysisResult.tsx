...
import type { AnalysisResult, RiskFlag, ActionItem, PlayerProfile, BenchmarkMetric } from '@/types';
import {
...
import {
  ...
  Mail, Printer, Share2, TrendingUp, Activity, Minus,
...
export const AnalysisResultView = ({ result, profile, onReset, isDark }: Props) => {
  ...
  const generatePDF = () => {
    ...
    // Users can save as PDF from the print dialog (most browsers support this)
    // This is the most reliable approach and handles all CSS properly
    window.print();
  };
    ...
    <div className="w-full animate-fade-in print:p-0">
      ...
      {viewMode === 'coach' ? (
        ...
        <div ref={reportContainerRef} className="space-y-6">
          ...
          <div className="pdf-section bg-white dark:bg-slate-800 rounded-xl p-6 mb-6 border border-slate-200 dark:border-slate-700">
            <div className="flex justify-between items-center">
              <div>
          ...
          {/* Executive Summary */}
          <div className="pdf-section bg-white dark:bg-slate-900/60 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-slate-200 dark:border-white/5 shadow-lg dark:shadow-xl mb-6">
          ...
          <div className="pdf-section bg-white dark:bg-slate-900/60 backdrop-blur-sm p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-lg dark:shadow-xl mb-6">
          ...
          <div className="pdf-section bg-white dark:bg-slate-900/60 backdrop-blur-sm p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-lg dark:shadow-xl flex flex-col justify-between mb-6">
              <div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                ...
                <div className="h-[200px] w-full mb-4 overflow-hidden">
                  <ResponsiveContainer width="100%" height="100%">
          ...
          {/* Reality Check */}
          <div className="pdf-section pdf-page-break-before bg-white dark:bg-slate-900/60 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-slate-200 dark:border-blue-500/20 shadow-lg dark:shadow-xl relative overflow-hidden group mb-6">
          ...
          {/* Funnel & Constraints */}
          <div className="pdf-section pdf-page-break-before grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
             {/* Recruiting Funnel */}
             <div className="pdf-section bg-white dark:bg-slate-900/60 backdrop-blur-sm p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-lg dark:shadow-xl">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6 flex items-center">
          ...
          {/* 90 Day Game Plan */}
          <div className="pdf-section pdf-page-break-before bg-white dark:bg-slate-900/60 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-slate-200 dark:border-white/5 shadow-lg dark:shadow-xl mb-6">
